...
Pod::Spec.new do |spec|
  ...
  spec.description  = "这是详细描述，这里的描述内容必须必summary长，不然会报错"

  spec.homepage     = "https://github.com/liutiesong/testPods"
  ...
  spec.source       = { :git => "https://github.com/liutiesong/testPods.git", :tag => "#{spec.version}" }
